    ...
    <footer className="max-container">
      ...
      >
        <div className="flex flex-col items-start">
          ...
          <p
            className="mt-6 text0base leading-7 font-montserrat text-white
          sm:max-w-sm"
          >
        ...
        <div className="flex flex-1 justify-betweenlg:gap-10 gap-20 flex-wrap">
          {footerLinks.map(section => (
            <div className="" key={section}>
              <h4 className="text-white font-montserrat text-3xl leading-normal font-medium mb-6">
                {section.title}
              </h4>
              <ul>
      ...
      <div className="flex justify-between text-white mt-24 max-sm:flex-col max-sm:items-center">
        <div className="flex flex-1 justify-start items-center gap-2 font-montserrat cursor-pointer">
          ...
          />
          <p>
            Copyright. This items are copied from JavaScript Mastery youtube
            channel
          </p>
        </div>
        <p className="font-montserrat cursor-pointer">
          Video Link - https://youtu.be/tS7upsfuxmo?si=b_rQZa8jkKsJsQXj
        </p>
      </div>
    </footer>
  )
